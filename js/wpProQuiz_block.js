    ...
    function createSelectElment(el, props, quizner, withServerRender) {
        return el(
            ...
            withServerRender ? el(ServerSideRender, {
                key: 'editable',
                block: 'AtozSites-Pro-Quiz/quiz',
                attributes: props.attributes
            }) : null
        )
    }

    wp.blocks.registerBlockType('AtozSites-Pro-Quiz/quiz', {
        title: 'AtozSites-Pro-Quiz',
        icon: 'universal-access-alt',
        category: 'common',
        example: {},
        edit: withSelect(function (select) {
            var attr = select('core/blocks').getBlockType('AtozSites-Pro-Quiz/quiz').attributes;
