...
class WpProQuiz_Plugin_BpAchievementsV2
{
    ...
    public function setCategoryName($category_name, $category)
    {
        ...
        if (__($other, 'dpa') == $category_name && 'AtozSites-Pro-Quiz' == $category) {
            return 'AtozSites-Pro-Quiz';
        } else {
    ...
    public static function install()
    {
        ...
        $actions = array(
            array(
                'category' => 'AtozSites-Pro-Quiz',
                'name' => 'wp_pro_quiz_quiz_finished',
                'description' => __('The user completed a quiz.', 'AtozSites-Pro-Quiz')
            )
        );
