...
class WpProQuiz_View_StatisticsAjax extends WpProQuiz_View_View
{
    ...
    public function showHistoryTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr>
                <th scope="col"><?php _e('Username', 'AtozSites-Pro-Quiz'); ?></th>
                ...
                <th scope="col" style="width: 200px;"><?php _e('Date', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Solved', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Results', 'AtozSites-Pro-Quiz'); ?></th>
            </tr>
            </thead>
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $model->getQuizId(); ?>&user_id=0&ref_id=<?php echo $model->getStatisticRefId(); ?>&avg=0&noheader=true"><?php _e('Export', 'AtozSites-Pro-Quiz'); ?></a>
                                </span>
                            </div>
                        ...
                        <th><?php echo $model->getSolvedCount() < 0 ? '---' : sprintf(__('%d of %d', 'AtozSites-Pro-Quiz'),
    ...
    public function showUserTable()
    {
        ...
        <h2><?php printf(__('User statistics: %s', 'AtozSites-Pro-Quiz'), esc_html($this->userName)); ?></h2>
        <?php if ($this->avg) { ?>
        <h2>
    ...
    <?php } ?>
        ...
        <table class="wp-list-table widefat" style="margin-top: 20px;">
            ...
            <tr>
                ...
                <th scope="col"><?php _e('Question', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Hints used', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Solved', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Time', 'AtozSites-Pro-Quiz'); ?> <span
                        style="font-size: x-small;">(hh:mm:ss)</span></th>
                <th scope="col" style="width: 100px;"><?php _e('Points scored', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 60px;"><?php _e('Results', 'AtozSites-Pro-Quiz'); ?></th>
            </tr>
            </thead>
            <tbody>
            ...
            foreach ($this->userStatistic as $cat) {
                ...
                <tr class="categoryTr">
                    <th colspan="9">
                        <span><?php _e('Category', 'AtozSites-Pro-Quiz'); ?>:</span>
                ...
                <?php foreach ($cat['questions'] as $q) {
                    ...
                    <tr>
                        ...
                        <th><?php echo $q['solvedCount'] < 0 ? '---' : ($q['solvedCount'] ? __('yes',
                                'AtozSites-Pro-Quiz') : __('no', 'AtozSites-Pro-Quiz')); ?></th>
                ...
                <tr class="categoryTr" id="wpProQuiz_ctr_222">
                    <th colspan="2">
                        <span><?php _e('Sub-Total: ', 'AtozSites-Pro-Quiz'); ?></span>
                    </th>
                    ...
                    <th><?php echo $cSolvedCount < 0 ? '---' : sprintf(__('%d of %d', 'AtozSites-Pro-Quiz'), $cSolvedCount,
                            $sum); ?></th>
            ...
            <tr id="wpProQuiz_tr_0">
                <th></th>
                <th><?php _e('Total', 'AtozSites-Pro-Quiz'); ?></th>
                ...
                <th><?php echo $gSolvedCount < 0 ? '---' : sprintf(__('%d of %d', 'AtozSites-Pro-Quiz'), $gSolvedCount,
                        $sum); ?></th>
        ...
        <div style="margin-top: 10px;">
            <div style="float: left;">
                <a class="button-secondary wpProQuiz_update" href="#"><?php _e('Refresh', 'AtozSites-Pro-Quiz'); ?></a>
                <a class="button-secondary wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $this->userId; ?>&ref_id=<?php echo $this->refId; ?>&avg=<?php echo $this->avg; ?>&noheader=true"><?php _e('Export', 'AtozSites-Pro-Quiz'); ?></a>
            </div>
...
// 			$a .= '<span class="wpProQuiz_clozeCorrect" style="display: none;">('.implode(', ', $rowText).')</span></span>';
                                    ...
                                    <td>
                                        ...
                                        switch ($form->getType()) {
                                            ...
                                            case WpProQuiz_Model_Form::FORM_TYPE_CHECKBOX:
                                                echo $str == '1' ? __('ticked', 'AtozSites-Pro-Quiz') : __('not ticked',
                                                    'AtozSites-Pro-Quiz');
                                                break;
    ...
    public function showOverviewTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr>
                <th scope="col"><?php _e('User', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Points', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Correct', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Incorrect', 'AtozSites-Pro-Quiz'); ?></th>
                <th scope="col" style="width: 100px;"><?php _e('Hints used', 'AtozSites-Pro-Quiz'); ?></th>
            ...
            <?php } else { ?>
                ...
                <?php foreach ($this->statisticModel as $model) {
                    ...
                    if (!$model->getUserId()) {
                        $model->setUserName(__('Anonymous', 'AtozSites-Pro-Quiz'));
                    }
                    ...
                    <tr>
                        <th>
							...
							<span>
                                ...
                                |
                                <span>
                                    <a class="wpProQuiz_export" href="#" data-baseurl="admin.php?page=wpProQuiz&module=statistic_export&action=user_export&quiz_id=<?php echo $this->quizId; ?>&user_id=<?php echo $model->getUserId(); ?>&ref_id=0&avg=1&noheader=true"><?php _e('Export', 'AtozSites-Pro-Quiz'); ?></a>
                                </span>
                            </div>
