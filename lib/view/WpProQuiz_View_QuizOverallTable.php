...
class WpProQuiz_View_QuizOverallTable extends WP_List_Table
{
    ...
    public static function getColumnDefs()
    {
        $columns = array(
            ...
            'name' => __('Name', 'AtozSites-Pro-Quiz'),
            'category' => __('Category', 'AtozSites-Pro-Quiz'),
            'shortcode' => __('Shortcode', 'AtozSites-Pro-Quiz'),
            'shortcode_leaderboard' => __('Shortcode-Leaderboard', 'AtozSites-Pro-Quiz')
        );
    ...
    function __construct($quizItems, $quizCount, $categoryItems, $perPage)
    {
        parent::__construct(array(
            'singular' => __('Quiz', 'AtozSites-Pro-Quiz'),
            'plural' => __('Quiz', 'AtozSites-Pro-Quiz'),
            'ajax' => false,
    ...
    function no_items()
    {
        _e('No data available', 'AtozSites-Pro-Quiz');
    }
    ...
    function get_bulk_actions()
    {
        ...
        if (current_user_can('wpProQuiz_delete_quiz')) {
            $actions['delete'] = __('Delete', 'AtozSites-Pro-Quiz');
        }

        if (current_user_can('wpProQuiz_export')) {
            $actions['export'] = __('Export', 'AtozSites-Pro-Quiz');
        }

        if (current_user_can('wpProQuiz_edit_quiz')) {
            $actions['set_category'] = __('Set Category', 'AtozSites-Pro-Quiz');
        }
